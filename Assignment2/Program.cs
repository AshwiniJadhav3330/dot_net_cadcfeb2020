...
namespace Assignment2
{
    ...
    public abstract class Employee
    {
        ...
        public Employee(string Name = "Ashwini", decimal Basic = 100, short DeptNo = 10)
        {
            EmpNo++;
            this.EMPNO += EmpNo;
            this.NAME = Name;
    ...
    public class Manager : Employee
    {
        ...
        public Manager(string Designation = "mgr", string Name = "Anuja", decimal Basic = 1200, short DeptNo = 30) : base(Name, Basic, DeptNo)
        {
    ...
    public class GeneralManager : Manager
    {
        ...
        public GeneralManager(string Designation = "mgr", string Name = "Anuja", decimal Basic = 1200, short DeptNo = 30) : base(Designation, Name, Basic, DeptNo)
        {
        }
    ...
    {
        public CEO(string Name = "Shruti", decimal Basic = 100, short DeptNo = 10) : base(Name, Basic, DeptNo)
        {
        }
        public override decimal BASIC
        {
